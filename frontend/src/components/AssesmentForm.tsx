...
const AssessmentForm: React.FC = () => {
  ...
  const validateUserData = () => {
    ...
    if (!/^\S+@\S+\.\S+$/.test(userData.email)) newErrors.push('Email is invalid');
    ...
    <div className="max-w-4xl shadow-xl mx-auto">
      ...
      {step === 'user' ? (
        <div className="bg-white rounded-lg shadow p-6">
          <h2 className="text-2xl flex justify-center font-bold mb-8">Your Information</h2>
        ...
        <div className="bg-white rounded-lg shadow p-6">
          ...
          <p className="mb-6 text-gray-600">
            Please rate each statement on a scale of 1-5 according to the provided scale. 
            Your honest assessment will help identify your organization's innovation strengths and opportunities.
          </p>
